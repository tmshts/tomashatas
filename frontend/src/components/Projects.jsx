...
const speak_ref = useRef(null);

    return (

        <>

            <Navbar real_estate_ref={real_estate_ref} blog_ref={blog_ref} master_paper_ref={master_paper_ref} gym_ref={gym_ref} christmas_ref={christmas_ref} speak_ref={speak_ref} />
                ...
                <div key={project.ID}>
                        ...
                        <Link style={padding} to={`/projects/${project.ID}`}>
                                ...
                                <div className='project_image'>
                                    {project.ID == 1 && <img ref={gym_ref} src={GymProgg_main} className='project_foto_mini' alt="GymProgg_main"/> }
                                    {project.ID == 2 && <img ref={speak_ref} src={Speak_intro} className='project_foto_mini' alt="Speak_intro"/> }
                                    {project.ID == 3 && <img ref={real_estate_ref} src={Real_estate_overview} className='project_foto_mini' alt="Real_estate_overview"/> }
                                    {project.ID == 4 && <img ref={blog_ref} src={Blog_blogs} className='project_foto_mini' alt="Blog_blogs"/> }
                                    {project.ID == 5 && <img ref={christmas_ref} src={Christmas_sweet_home} className='project_foto_mini' alt="Christmas_sweet_home"/> }
                                    {project.ID == 6 && <img ref={master_paper_ref} src={Master_paper_home} className='project_foto_mini' alt="Master_paper_home"/> }
                                </div>
